...
#' @param master If provided, the tree will be plotted using the branch lengths of that tree, coloring branches by the phenotype in the phenotype tree. The master tree and phenotype tree MUST have the same topology and the same species. If not provided, use.edge.length is set to FALSE.
