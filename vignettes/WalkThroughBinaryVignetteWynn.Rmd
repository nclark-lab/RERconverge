...
par(mfrow=c(1,2))
#The following function is not in the compiled R package but is available in 'plottingFuncs.R' on 'UpdateVignette' branch....
...
plotRers(mamRERv,"BEND3",phenv=phenvExample) #plot RERs
```
...
2) Provide a list of species to use as foreground species. This only allows inclusion of extant lineages, so in this case, the Killer whale-Dolphin ancestor will no longer be included.
