...
To produce multiple permulations using the CC method, the function `generatePermulatedBinPhen` can be used, specifying `permmode`="cc". For example, the code below produces 20 CC permulations:




To produce multiple permulations of ONE gene using the SSM method, `generatePermulatedBinPhen can also be used with `permmode`="ssm". The code below produces 10 SSM permulations of TTN:
