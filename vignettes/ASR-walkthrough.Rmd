...
# the number of models the search returns depends on the data, so index
# relative to its length rather than hardcoding positions
search1 = filtered_res1[[length(filtered_res1)]]
search2 = filtered_res1[[1]]

rate_models = list(getMatrixFromAbbr("ER", 3), getMatrixFromAbbr("ARD",3),
                   getMatrixFromAbbr("SYM",3), search1, search2,
                   custom)
