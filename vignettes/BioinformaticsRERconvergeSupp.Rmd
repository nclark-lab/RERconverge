...
if (!require("RERconverge", character.only=T, quietly=T)) {
    ...
    install_github("nclark-lab/RERconverge",
                   ref="RoxygenizeAddressReviewerComments") #can be modified to specify a particular branch
}
library(RERconverge)
```
...
#plot RERs as tree
par(mfrow=c(1,1))
bend3rers = returnRersAsTree(toyTrees, mamRERw, "BEND3", plot = TRUE) #plot RERs
```
