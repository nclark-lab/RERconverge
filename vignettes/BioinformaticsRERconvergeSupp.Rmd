...
The function `returnRersAsTreesAll` will produce an object of class "multiPhylo", with each element containing a named gene tree with branch lengths representing RERs for that gene. This can then be saved to a file using `write.tree` for further analysis or customized plotting.
