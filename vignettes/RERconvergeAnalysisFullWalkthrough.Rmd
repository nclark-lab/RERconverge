...
#   load(paste(rerpath,'/data/logAdultWeightcm.RData',sep=''))
# }
mamRERw=RERconverge::getAllResiduals(mamTrees,useSpecies=names(logAdultWeightcm), 
...
par(mfrow=c(1,2))
#The following function is not in the compiled R package but is available in 'plottingFuncs.R' and separately in 'plotTreeHighlightBranches.R' on the 'UpdateVignette' branch....
if (!exists('plotTreeHighlightBranches')) {
  repopath = "C:/Users/apacz/Documents/GitHub/RERconverge" #modify this to the location of the repo
  source(paste(repopath,"/R/plotTreeHighlightBranches.R", sep=""))
}
...
```{r fig9, fig.height=9, fig.width=10, warning = FALSE, cache = TRUE}
...
```{r fig10, fig.height=5, fig.width=10}
