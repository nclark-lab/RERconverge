...
Please refer to the [Install page](https://github.com/nclark-lab/RERconverge/wiki/Install) for detailed instructions to **install** RERconverge from scratch. For more information on running RERconverge, we suggest beginning with the [Full Walkthrough](https://cdn.rawgit.com/nclark-lab/RERconverge/master/vignettes/FullWalkthroughUTD.pdf). Additionally, the [Permulation Walkthrough](https://github.com/nclark-lab/RERconverge/blob/master/vignettes/PermulationWalkthrough.pdf) describes using "permulations" to estimate empirical P-values, and the [Tree Building Walkthrough](https://github.com/nclark-lab/RERconverge/blob/master/vignettes/PhangornTreeBuildingWalkthrough.pdf) describes our wrapper functions to estimate gene trees using Phangorn for use in RERconverge. The [full documentation](https://github.com/nclark-lab/RERconverge/blob/master/RERconverge_master.pdf) is also available. All walkthroughs are found here also --> [R vignettes](https://github.com/nclark-lab/RERconverge/wiki/Vignettes).
